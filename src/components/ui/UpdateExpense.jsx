...
const UpdateExpense = ({expense}) => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            setLoading(true);
            // Add API call here
            const res = await axios.put(`https://expense-tracker-backend-m0fv.onrender.com/api/v1/expense/update/${expense._id}`, formData, {
                    headers: {
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Update an expense here. Click "Update" when you're done.
                    </DialogDescription>
                </DialogHeader>
